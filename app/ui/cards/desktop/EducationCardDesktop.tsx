...
const EducationCardDesktop = () => {
  const [educationHovered, setEducationHovered] = useState<number | null>(null);
    ...
    <div className="flex h-[80vh] flex-col justify-between gap-8 lg:h-[60vh]">
      ...
      <section className="flex flex-col gap-4 overflow-auto">
        {education.map((education, i) => (
          <div
            key={i}
            className={`pr-4 pt-8 transition-all ${educationHovered !== null && (i === educationHovered ? "" : "opacity-30")}`}
            onMouseEnter={() => setEducationHovered(i)}
